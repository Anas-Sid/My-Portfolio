...
const IntroBanner = () => {
  return (
    <section className="relative bg-[#1a1a1a] text-white py-16 px-6 md:px-16 overflow-hidden -mt-[150px]">
      {/* Angled Background Effect */}
      <div className="absolute top-0 left-0 w-full h-full bg-[#1a1a1a] transform -skew-y-3 z-0"></div>
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        ...
        <p className="text-gray-300 w-[980px] -mr-[360px]">
