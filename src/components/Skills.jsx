...
const Skills = () => {
  return (
    <section id="skills" className="py-20 px-6 md:px-16 bg-[#1a1a1a] -m-12">
      <div className="text-center mb-12">
        <h2 className="text-3xl font-bold mb-4 text-white">Skills</h2>
        <p className="text-white">Technologies I work with</p>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-8 place-items-center">
        {skills.map((skill, idx) => (
          <a
            ...
            className="flex flex-col items-center justify-center w-28 h-28 bg-white rounded-full shadow hover:scale-105 transition-all"
          >
            {skill.icon}
